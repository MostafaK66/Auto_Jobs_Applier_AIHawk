...
class AIHawkAuthenticator:
        ...
        try:
            ...
            while True:
                ...
                if "feed" in current_url:
                    ...
                    logger.debug(
                        "Password field detected, waiting for login completion."
                    )
    ...
    def is_logged_in(self):
        try:
            ...
            profile_img_elements = self.driver.find_elements(
            ...
            logger.info(
                "Did not find 'Start a post' button or profile image. User might not be logged in."
            )
            return False
